function useConfSignupForm(states,profileORsignup) {
  const configs = [
    {
      labelText: "Email",
    ...
    },
    {
      ...
      onChange:  profileORsignup ? states.passwordOnChange : states.oldPasswordOnChange,
      type: "password",
    },
    {
      labelText: profileORsignup ? "Confirem password" : "New  password",
      placeHolder: profileORsignup ? "Confirm password" : "New password",
      value: profileORsignup ? states.confirmPasswordValue:states.newPasswordValue,
      onChange: profileORsignup ? states.confirmPasswordOnChange :states.newPasswordOnChange,
      type: "password",
    },
    {
...
export default useConfSignupForm;
